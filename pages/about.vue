  ...
  <section>
    <UCard>
      ...
      <ul class="mt-4 list-disc list-inside text-sm text-gray-600">
        ...
        <li>Affichage et rendu sécurisé du contenu markdown</li>
        <li>Stockage des notes dans un dossier versionné</li>
      </ul>
      <p class="mt-4 text-xs text-gray-400">Développé avec ❤️ par Adrien.</p>
    </UCard>
  </section>
</template>
